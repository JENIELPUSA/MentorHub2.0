            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div className="card">
                    <div className="card-header">
                        <div className="w-fit rounded-lg bg-[#003366]/10 p-2 text-[#003366] transition-colors dark:bg-[#FFD700]/10 dark:text-[#FFD700]">
                            <Package size={26} />
                        </div>
                    ...
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        ...
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-[#003366] px-2 py-1 font-medium text-[#003366] dark:border-[#FFD700] dark:text-[#FFD700]">
                            <TrendingUp size={18} />
                            25%
                        </span>
                    </div>
                ...
                <div className="card">
                    <div className="card-header">
                        <div className="rounded-lg bg-[#003366]/10 p-2 text-[#003366] transition-colors dark:bg-[#FFD700]/10 dark:text-[#FFD700]">
                            <DollarSign size={26} />
                        </div>
                            ...
                            >
                                <defs>
                                    ...
                                    >
                                        <stop
                                            offset="5%"
                                            stopColor={theme === "light" ? "#003366" : "#FFD700"}
                                            stopOpacity={0.8}
                                        />
                                        <stop
                                            offset="95%"
                                ...
                                <Area
                                    type="monotone"
                                    dataKey="total"
                                    stroke={theme === "light" ? "#003366" : "#FFD700"}
                                    fillOpacity={1}
                                    fill="url(#colorTotal)"
                                />
                            </AreaChart>
                            ...
                            >
                                <div className="flex items-center gap-x-4">
                                    <img
                                        src={sale.image}
                                        alt={sale.name}
                                        className="size-10 flex-shrink-0 rounded-full object-cover border border-[#003366]/20 dark:border-[#FFD700]/20"
                                    />
                                ...
                                <p className="font-medium text-[#003366] dark:text-[#FFD700]">${sale.total}</p>
                            </div>
                        ))}
                    </div>
                </div>
                            ...
                            <tbody className="table-body">
                                {topProducts.map((product) => (
                                    ...
                                    >
                                        ...
                                        <td className="table-cell">
                                            <div className="flex items-center gap-x-4">
                                                <button className="text-[#003366] hover:opacity-80 dark:text-[#FFD700]">
                                                    <PencilLine size={20} />
                                                </button>
